...
for ibJ, nblock in enumerate(nblocks):
  ...
  pl.suptitle('eigDef-PCG for multiple correlated SPD matrices (1,000,000 DoFs) and a constant right-hand side', y=1.08, fontsize=18)
pl.savefig('Example2_mops.png', bbox_inches='tight')
